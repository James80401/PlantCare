...
| 6 - consistent existing UX | Automated gates complete | [Phase 6 implementation evidence](../operations/release-evidence-2026-07-23-phase-6.md): retry-safe Add Plant and Dr. Plant flows, explicit task rollback, idempotent household operations, concurrent community protections, complete catalog photo coverage, and [CI run 30063024797](https://github.com/James80401/PlantCare/actions/runs/30063024797) pass. |
...
| 8 - visibility and release sign-off | Automated gates pass; deploy pending | [Phase 8 implementation evidence](../operations/release-evidence-2026-07-23-phase-8.md): buildable optional Sentry, activation/version observability, normalized existing events, Android CI, release-version enforcement, zero-vulnerability audit, and [CI run 30063024797](https://github.com/James80401/PlantCare/actions/runs/30063024797) pass. Main deployment evidence remains. |
