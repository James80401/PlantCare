...
| 5 - bounded, side-effect-free reads | Ready to merge | [Phase 5 release evidence](../operations/release-evidence-2026-07-23-phase-5.md): mutation-free read contracts, embedded garden summaries, bounded selects, explicit refresh, indexes, response-size logs, request cancellation, and PostgreSQL 0/10/100-plant gates pass. Production deployment evidence remains. |
| 6-8 | Queued | Work begins after the active read/performance slice is recorded. |
