...
| 4 - notifications, billing, AI | Complete | [Phase 4 release evidence](../operations/release-evidence-2026-07-23-phase-4.md): timezone-safe delivery, honest per-channel status, capability gates, Stripe lifecycle hardening, bounded AI retries, source labels, image moderation, idempotent chat retry, CI, and production deployment pass. Buddy and paid billing remain disabled. |
| 5 - bounded, side-effect-free reads | Complete | [Phase 5 release evidence](../operations/release-evidence-2026-07-23-phase-5.md): mutation-free reads, bounded dashboard selects, PostgreSQL performance gates, [main CI 30055670756](https://github.com/James80401/PlantCare/actions/runs/30055670756), and [production deploy 30055808149](https://github.com/James80401/PlantCare/actions/runs/30055808149) pass. |
| 6 - consistent existing UX | Complete | [Phase 6 implementation evidence](../operations/release-evidence-2026-07-23-phase-6.md): retry-safe Add Plant and Dr. Plant flows, explicit task rollback, idempotent household operations, concurrent community protections, complete catalog photo coverage, and [main CI run 30063415020](https://github.com/James80401/PlantCare/actions/runs/30063415020) pass. |
| 7 - accessibility and Android | External evidence remains | [Phase 7 implementation evidence](../operations/release-evidence-2026-07-23-phase-7.md): dialog/route focus hardening, production Android build path, version `1.1 (2)`, and store preflight 10/10 pass. Push is 4/5 without server FCM credentials; the signed closed-track/device and manual accessibility matrix require operator/device access. |
| 8 - visibility and release sign-off | Automated implementation complete; external gates remain | [Phase 8 implementation evidence](../operations/release-evidence-2026-07-23-phase-8.md): buildable optional Sentry, activation/version observability, normalized existing events, Android CI, release-version enforcement, [main CI run 30063415020](https://github.com/James80401/PlantCare/actions/runs/30063415020), and [exact-SHA production deploy 30063569324](https://github.com/James80401/PlantCare/actions/runs/30063569324) pass. Legal approval, server FCM credentials, manual accessibility evidence, and signed closed-track Android evidence remain external release gates. |
