...
| 6 - consistent existing UX | Local gates pass; CI pending | [Phase 6 implementation evidence](../operations/release-evidence-2026-07-23-phase-6.md): retry-safe Add Plant and Dr. Plant flows, explicit task rollback, idempotent household operations, concurrent community protections, complete catalog photo coverage, and 48 enabled desktop/mobile E2E scenarios pass. |
...
| 8 - visibility and release sign-off | Local gates pass; CI/deploy pending | [Phase 8 implementation evidence](../operations/release-evidence-2026-07-23-phase-8.md): buildable optional Sentry, activation/version observability, normalized existing events, Android CI, release-version enforcement, zero-vulnerability audit, and complete local verification pass. Final CI/deploy evidence remains. |
