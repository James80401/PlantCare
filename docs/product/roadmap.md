...
| PHOTO-1 | Exact reusable images for final catalog gaps | Later / Blocked on source | Hoya Mathilde and String of Dolphins still lack exact reusable CC0/CC-BY/CC-BY-SA sources after the 2026-07-03 iNaturalist/Commons/source-resolver pass. Do not use nursery/blog images or parent-species substitutes without a product decision. See [species-photo-sourcing-log.md](species-photo-sourcing-log.md). |
